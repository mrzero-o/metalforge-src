...
import net.metalforge.mod.inventory.ContainerHTSmerlter;
...
public class GuiSmelter extends GuiContainer{
	...
	public int tier;
	private TileEntitySmelter tileFurnace;

	public GuiSmelter(InventoryPlayer invPlayer, TileEntitySmelter tile, int tier) {
		super(new ContainerHTSmerlter(invPlayer, tile, tier));
	...
	public static String getTextureName(int tier){
		return MFMod.MODID + ":" + "textures/gui/container/smelterGuiT" + tier + ".png";
	}
}