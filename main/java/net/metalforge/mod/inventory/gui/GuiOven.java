...
import net.metalforge.mod.inventory.ContainerHTOven;
...
public class GuiOven extends GuiContainer{
	...
	public int tier;
	private TileEntityOven tileFurnace;

	public GuiOven(InventoryPlayer invPlayer, TileEntityOven tile, int tier) {
		super(new ContainerHTOven(invPlayer, tile, tier));
	...
	public static String getTextureName(int tier){
		return MFMod.MODID + ":" + "textures/gui/container/ovenGuiT" + tier + ".png";
	}
}