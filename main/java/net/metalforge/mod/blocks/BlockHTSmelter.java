...
public class BlockHTSmelter extends BlockContainerMF {
	...
	public BlockHTSmelter(boolean isActive, int tier) {
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(this.tier == 1 ? MFBlocks.HTSmelterIdle : MFBlocks.MetalSmelterIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			if(!player.isSneaking()){
				player.openGui(MFMod.INSTANCE, MFGuiHandler.SMELTER, world, x, y, z);
			}
		}
		return true;
	}
	...
	public TileEntity createNewTileEntity(World world, int i) {
		return (new TileEntitySmelter().setTier(this.tier));
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack) {
		...
		if(itemstack.hasDisplayName()) {
			((TileEntitySmelter)world.getTileEntity(x, y, z)).getInventoryName();
		}
	}
	...
	public static void updateMachineState(boolean active, World world, int xCoord, int yCoord, int zCoord) {
		...
		if(world.getBlock(xCoord, yCoord, zCoord) == MFBlocks.HTSmelterIdle && active) {
			world.setBlock(xCoord, yCoord, zCoord, MFBlocks.HTSmelterActive);
		}else if(world.getBlock(xCoord, yCoord, zCoord) == MFBlocks.HTSmelterActive && !active){
			world.setBlock(xCoord, yCoord, zCoord, MFBlocks.HTSmelterIdle);
		}
		
		if(world.getBlock(xCoord, yCoord, zCoord) == MFBlocks.MetalSmelterIdle && active) {
			world.setBlock(xCoord, yCoord, zCoord, MFBlocks.MetalSmelterActive);
		}else if(world.getBlock(xCoord, yCoord, zCoord) == MFBlocks.MetalSmelterActive && !active){
			world.setBlock(xCoord, yCoord, zCoord, MFBlocks.MetalSmelterIdle);
		}
