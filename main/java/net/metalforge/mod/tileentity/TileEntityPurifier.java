...
public class TileEntityPurifier extends TileEntityBT implements ISidedInventory
{
	public int tier;
    ...
    public int cookTime;
    private String field_145958_o = StringUtil.getPurifierGuiName();
    private static final String __OBFID = "CL_00000357";
    public int speed(){
    	if(this.tier == 2) return 70;
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockPurifier.updateMachineState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = PurifierRecipes.purifying().getPurifyingResult(this.slots[0]);
