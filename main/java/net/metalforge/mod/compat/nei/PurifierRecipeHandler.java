...
public class PurifierRecipeHandler extends TemplateRecipeHandler
{
    ...
    public String getRecipeName() {
        return StringUtil.getPurifierGuiName();
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if(outputId.equals("purifying") && getClass() == PurifierRecipeHandler.class) {
            Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) PurifierRecipes.purifying().getPurifyingList();
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        if(inputId.equals("fuel") && getClass() == PurifierRecipeHandler.class)
    ...
    public String getGuiTexture() {
        return GuiPurifier.getTextureName(1);
    }
    ...
    private static void findFuels() {
        ...
        for(ItemStack item : ItemList.items){
            if(!efuels.contains(item.getItem())) {
                int burnTime = TileEntityPurifier.getNormalItemBurnTime(item, 1);
                if (burnTime > 0)
